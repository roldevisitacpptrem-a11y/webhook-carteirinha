...
# 🔐 Configurações de acesso ao Google Sheets
SCOPES = ['https://www.googleapis.com/auth/spreadsheets.readonly']
SPREADSHEET_ID = '1EpGuRD02oPPJOT1O6L08aqWWZuD25ZmkV9jD6rUoeAg'
RANGE_NAME = 'carteirinhas_ok!A:D'  # Lê todas as linhas da aba
...
def webhook():
    ...
    try:
        # Garante que a matrícula seja string
        ...
        for row in values:
            if len(row) >= 1 and row[0].strip() == matricula:
